...
latex_documents = [
    (master_doc, 'LIMOpy.tex', u'LIMOpy Documentation',
...
man_pages = [
    (master_doc, 'LIMOpy', u'LIMOpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LIMOpy', u'LIMOpy Documentation',
     author, 'LIMOpy', 'Linear regression analysis',
     'Miscellaneous'),
]
